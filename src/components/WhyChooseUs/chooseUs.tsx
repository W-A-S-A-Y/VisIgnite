    ...
    <div style={styles.wrapper}>
      <div style={styles.container}  className= 'dark:bg-black'>
        ...
        <div style={styles.sectionHighlight}>
          <h3 style={{ fontWeight: 'bold', fontSize: '18px' }}>Cost Effective</h3>
          <p>
        ...
        <div style={styles.section}>
          <h3 style={{ fontWeight: 'bold', fontSize: '18px' }}>Tailored Service</h3>
          <p>
...
const styles = {
  ...
  section: {
    flex: 1,
    padding: '20px',
    backgroundColor: '#86a7e0',   // Standard orange background
    borderRadius: '10px',
  ...
  sectionHighlight: {
    ...
    padding: '20px',
    backgroundColor: '#324898',     // Dark green background
    borderRadius: '10px',
